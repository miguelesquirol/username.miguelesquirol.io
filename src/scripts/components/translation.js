...
resources: {
  pt: {
    translation: {
      ...
      "logo3" : "Metro",
      "logo3-text" : "<li>Plateforme d’identité visuelle</li><li>Guide de normes graphiques</li><li>Livre de marque</li>",
      "logo4" : "Fromagerie Bergeron",
      "logo4-text" : "<li>Vidéo promotionnelle</li>",
      "logo5" : "Similac",
      "logo5-text" : "<li>Refonte du site web</li><li>Expérience Usager</li><li>Illustrations originales</li><li>Montage photo</li><li>Réseaux sociaux</li>",
      "logo6" : "Formula 1",
      "logo6-text" : "<li>Design de logos</li><li>Produits dérivés</li><li>Production québécoise</li>",
      "logo7" : "STM",
      "logo7-text" : "<li>Campagnes 360</li><li>Expérience client</li>",
      "logo8" : "Mikes",
      "logo8-text" : "<li>Campagnes numériques</li><li>Bannières web</li>",
      "logo9" : "Ensure",
      "logo9-text" : "<li>Refonte du site web</li><li>User Experience</li><li>Montage photo</li>",
      "logo10" : "CSJR",
      "logo10-text" : "<li>Refonte de l'identité visuelle</li><li>Site web</li><li>Affichage, dépliants et invitations</li>",
      "logo11" : "La Presse",
      "logo11-text" : " <li> Mise en page sur tablette</li><li>Illustrations originales</li><li>Data visuel, infographies</li><li>Expérience Usager</li>", 
      "logo12" : "Bombardier",
      "logo12-text" : "<li>Encarts publicitaires imprimés </li><li>Carte de Noël</li>"
    }
  },
  fr: {
    translation: {
